...
needy_resource_request* nr_client_resource_request_new(pid_t pid, size_t requestedResources);
needy_resource_request* nr_client_resource_request_deserialize(json_t* data);
json_t* nr_client_resource_request_serialize(const needy_resource_request* this);
