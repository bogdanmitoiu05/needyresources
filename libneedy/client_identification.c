...
nr_client_identification_header * nr_client_identification_header_new(pid_t pid, const char *workspace_path) {
    ...
    nr_client_identification_header* header = calloc(1, sizeof(nr_client_identification_header));
...
nr_client_identification_header * nr_client_identification_header_deserialize(json_t *data) {
    ...
    nr_client_identification_header* res = nr_client_identification_header_new(pid,workspace_path);
    free(workspace_path);
    return res;
}
